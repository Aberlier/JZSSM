    ...
    <form class="layui-form" id= "form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="msgName" lay-verify="title" autocomplete="off" placeholder=""
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入" class="layui-textarea" name="msgContent"></textarea>
            </div>
        </div>
    </form>
</div>
<div class=" tkbtnfxd">
    <button type="button" class="layui-btn  layui-btn-normal float-right" onclick="addMsg('<%=loginId%>','<%=param%>','<%=role%>')">确定</button>
...
<script src="<%=basePath%>views/js/admin/msg/addmsg.js"></script>
<script>
